import{e as s,j as o}from"./app-ZfgPYJ1T.js";function u({checked:t,onChange:n,disabled:r=!1}){const{isAr:e}=s(),a=t?`translateX(${e?-20:20}px)`:"translateX(0px)";return o.jsx("button",{type:"button",role:"switch","aria-checked":t,"aria-label":e?"تبديل":"Toggle",onClick:()=>!r&&n(),disabled:r,className:`
