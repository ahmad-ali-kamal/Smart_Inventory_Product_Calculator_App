...
window.ExpiryForm = function () {
  ...
  var batchCount = 0;
  var _isOpen = false;
  var _threshold = 14; // fallback افتراضي، يُحدَّث عند كل open
  ...
  function _save() {
    _save = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var btn, collectedBatches, endpoint, payload, _$12, date, res, data, successPayload, _data$message;
  ...
  function _initListeners() {
    ...
    (_$9 = $('efSingleDate')) === null || _$9 === void 0 ? void 0 : _$9.addEventListener('input', function () {
      _updateSingleStatus();
      validate();
    });
