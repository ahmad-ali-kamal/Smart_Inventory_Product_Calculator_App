            ...
            <div style={card} onMouseEnter={hoverOn} onMouseLeave={hoverOff}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '8px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        {/* Label */}
                        <p style={labelStyle}>{t.settings_preview_label}</p>

                        {/* Rule badges — use supplied rules or show placeholder values */}
                        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
                            {rules?.length
                                ...
                                : (
                                    <>
                                        <PurpleBadge>{t.settings_preview_placeholder_area}</PurpleBadge>
                                        <PurpleBadge>{t.settings_preview_placeholder_waste}</PurpleBadge>
                                    </>
                                )
                            }
                        </div>
