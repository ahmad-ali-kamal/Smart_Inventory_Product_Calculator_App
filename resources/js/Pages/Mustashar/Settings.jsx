...
export default function Settings() {
    ...
    const {
        isLoading, isError, error, refetch,   // server / query state
        coverage, waste, errors, isSaving,    // form field state + validation
        handleCoverageChange, handleWasteChange, handleSave, // event handlers
    } = useSettingsForm();
