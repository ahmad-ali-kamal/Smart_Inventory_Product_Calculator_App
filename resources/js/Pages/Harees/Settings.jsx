...
const INITIAL_CATEGORIES = {
  short:  [],
  medium: [],
  long:   ["حلاج", "الشتاء", "المكتب", "الشتي", "مفرويات"],
};

// تعديل الألوان لتطابق درجة لون زر الحفظ (var(--primary))
const BUCKET_CONFIG = [
    ...
    <Layout>
      <div className="max-w-2xl mx-auto space-y-5 pb-10">
          ...
          <div className="grid grid-cols-3 gap-3">
            {["short", "medium", "long"].map((key) => (
              <div key={key}>
                ...
                {/* التركيز (Focus) يظهر الآن بلون رصاصي/أبيض متناسق */}
        ...
        <Card className="p-5 space-y-4">
          ...
          {/* الـ Tip بألوان مطابقة للمربعات ودرجات الموف الخاصة بالنظام */}
