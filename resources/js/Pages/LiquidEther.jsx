  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container) {
        ...
        // ✅ FIX: تعيين خلفية داكنة فوراً على الـ canvas
        // alpha:true يجعل الـ canvas شفافاً حتى يجهز الـ shader (~ثواني)
        // هذا يمنع الوميض الأبيض بتغطية الشفافية بلون داكن
        this.renderer.domElement.style.background = '#0F0E17';
