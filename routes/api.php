...
use App\Http\Controllers\Api\ApiProductController; // تم تعديل الاسم ليتطابق مع ملفك
use App\Http\Controllers\Calculator\ProductCalculatorController;
use App\Http\Controllers\Api\SallaWebhookController; // سننشئه لاحقاً للويب هوكس
...
// ====================================================================
// سلة ترسل البيانات هنا تلقائياً عند إضافة أو تعديل منتج
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        // ملاحظة: ألغينا مسار الـ Sync هنا لأننا سنعتمد على الويب هوكس
    });
